                    ...
                    <div className="flex justify-between items-start text-sm">
                        ...
                        <div className="flex flex-col sm:flex-row sm:space-x-12">
                            <div className="flex flex-col space-y-2">
                                ...
                                <Link href="#" className="hover:underline">What's New</Link>
                                <Link href="#" className="hover:underline">About Us</Link>
                            </div>
                            <div className="flex flex-col space-y-2">
                                <Link href="#" className="hover:underline">Where To Buy</Link>
                                <Link href="#" className="hover:underline">AVITA Store</Link>
                                <Link href="#" className="hover:underline">Contact AVITA</Link>
                            </div>
                            <div className="flex flex-col space-y-2">
                                <Link href="#" className="hover:underline">Support</Link>
                                <Link href="#" className="hover:underline">Repair Terms & Conditions</Link>
                                <Link href="#" className="hover:underline">Terms of Use Notice</Link>
