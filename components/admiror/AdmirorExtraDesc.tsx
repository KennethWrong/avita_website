      ...
      <div className="flex flex-col md:flex-row md:max-w-6xl mt-20">
        <div className="mb-10 md:mb-0 md:mr-24">
          <h2 className={`${styles.admiror_h2} mb-4 md:mb-8`}>
            {t("admiror_extra_title")}
          </h2>

          <span className="leading-8">{t("admiror_extra_content")}</span>
        </div>

        <div>
          <h2 className={`${styles.admiror_h2} mb-4 md:mb-8`}>
            {t("admiror_extra_title2")}
          </h2>

          <span className="leading-8">{t("admiror_extra_content2")}</span>
        </div>
      </div>
    </section>
  );
