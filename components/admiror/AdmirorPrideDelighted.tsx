...
export default function AdmirorPrideDelighted() {
  return (
    ...
    >
      ...
      <div className="flex flex-row max-w-6xl h-96 bg-[#f2f2f2]">
        ...
        <div className="flex flex-col justify-center items-center p-10">
          ...
          <span className="leading-6">
            ...
            display, both with extra-wide 178-degree viewing angle. The lifelike
            image quality, support up to 72% NTSC color gamut, offers an
            enjoyable viewing experience browsing websites or watching video
            clips.
          </span>
        </div>
      </div>
      ...
      {/* row 2 */}
      <div className="flex flex-row max-w-6xl h-96 bg-[#f2f2f2]">
        <img src="/images/admiror/bg_B1.jpg" alt="bg_B1" />
        ...
        <img src="/images/admiror/bg_B3_15_e.jpg" alt="B3_15_e" />
      ...
      <div className="flex flex-row max-w-6xl h-96 bg-[#f2f2f2]">
        <div className="flex flex-col justify-center items-center p-10">
          ...
          <span className="leading-6">
            ...
            each keycap in dimly-lit environments. Work and entertainment are no
            longer constrained by time and place. This feature makes
            uninterrupted workflow possible and helps you explore the world
            anytime anywhere.
          </span>
        </div>

        <img src="/images/admiror/bg_C2_15_e.jpg" alt="C2_15_e" />
        ...
        <div className="flex flex-col justify-center items-center p-10">
          ...
          <span className="leading-6">
            Music is a big part of an identity. ADMIROR's 2 full range speakers
            and 4 passive boosters are set to bring out the best audio-visual
